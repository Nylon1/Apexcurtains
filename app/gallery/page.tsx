...
function ProjectShowcase({
  ...
  return (
    <motion.section
      ...
      className="group overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.04] shadow-[0_40px_120px_rgba(0,0,0,0.45)]"
    >
      <div
      ...
      >
        <div className="relative h-[420px] sm:h-[520px] lg:min-h-[680px]">
        ...
        <div className="flex flex-col justify-between p-5 sm:p-8 lg:p-10">
          ...
          <div className="mt-10 rounded-[26px] border border-white/10 bg-black/20 p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-white/70">
              Start your own design journey and upload a photo of your window to
...
function ProjectModal({
  ...
  return (
    <motion.div
      ...
      onClick={onClose}
    >
      <div className="mx-auto flex min-h-screen max-w-7xl items-start justify-center px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <motion.div
          ...
          className="relative my-4 w-full overflow-hidden rounded-[30px] border border-white/10 bg-[#0d0d11] shadow-[0_40px_120px_rgba(0,0,0,0.55)] lg:my-8"
        >
          <button
            onClick={onClose}
          ...
          <div className="grid gap-6 lg:grid-cols-[1.02fr_0.98fr]">
            <div className="relative h-[420px] sm:h-[520px] lg:h-auto lg:min-h-[900px]">
              <Image
                src={project.image}
                alt={project.title}
                fill
              ...
              <div className="absolute inset-x-0 bottom-0 z-10 p-4 sm:p-8 lg:p-10">
                ...
                <h2 className="mt-5 text-3xl font-semibold leading-[1.05] sm:text-4xl lg:text-5xl">
                  {project.title}
                </h2>
            ...
            <div className="p-5 sm:p-8 lg:p-10">
              ...
              <div className="mt-10 rounded-[24px] border border-white/10 bg-white/5 p-6 shadow-[0_10px_40px_rgba(0,0,0,0.25)]">
                ...
                <div className="mt-6 border-t border-white/10 pt-5 text-sm text-white/55">
                  Have a similar apex or angled window? We can advise on
                  headings, linings and the most suitable curtain system.
                </div>
              </div>
            </div>
          </div>
